...
const clivalue_t valueTable[] = {
    ...
    { "rc_rateAcro", VAR_UINT8, &cfg.rcRate8Acro, 0, 250 },
    { "rc_expoAcro", VAR_UINT8, &cfg.rcExpo8Acro, 0, 100 },
    ...
    { "roll_pitch_rateAcro", VAR_UINT8, &cfg.rollPitchRateAcro, 0, 100 },
    { "yawrateAcro", VAR_UINT8, &cfg.yawRateAcro, 0, 100 },
