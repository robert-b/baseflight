...
const clivalue_t valueTable[] = {
    ...
    { "gps_port", VAR_INT8, &mcfg.gps_port, 0, SERIALPORT_MAX },
    { "msp_port", VAR_INT8, &mcfg.msp_port, 0, SERIALPORT_MAX },
    ...
    { "telemetry_port", VAR_UINT8, &mcfg.telemetry_port, 0, SERIALPORT_MAX },
    ...
    { "cruise_throttle", VAR_UINT16, &cfg.cruise_throttle, 1000, 2000 },
...
static void cliMixer(char *cmdline)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (strncasecmp(cmdline, mixerNames[i], len) == 0) {
            ...
            // TODO FIX ME : I am a Really Ugly Hack
